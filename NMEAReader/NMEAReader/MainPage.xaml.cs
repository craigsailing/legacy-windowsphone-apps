...
public partial class MainPage : PhoneApplicationPage
    {
        ...
        private async void BtnConnect_Click(object sender, RoutedEventArgs e)
        {
            if (_nmeaData.Connected == false)
            {
                try
                {
                    ...
                    //If you can connect alow this to be disconected
        ...
        private void LoggingState_CheckedChanged(object sender, Telerik.Windows.Controls.CheckedChangedEventArgs e)
        {
            //Enable Logging state if checked.
            DataLogger.Instance.Logging = LoggingState.IsChecked;
        }
